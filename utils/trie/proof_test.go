...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *fdb.MemDatabase {
	var provers []func(key []byte) *fdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *fdb.MemDatabase {
		proof := fdb.NewMemDatabase()
