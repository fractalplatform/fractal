...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	//add asset function
    make_shared<MagicVariableDeclaration>("setassetowner", make_shared<FunctionType>(strings{"uint256","address"}, strings{"uint256"}, FunctionType::Kind::SetAssetOwner)),
    make_shared<MagicVariableDeclaration>("addasset", make_shared<FunctionType>(strings{"uint256","address","uint256"}, strings{"uint256"}, FunctionType::Kind::AddAsset)),
    make_shared<MagicVariableDeclaration>("issueasset", make_shared<FunctionType>(strings{"string memory"}, strings{"uint256"}, FunctionType::Kind::IssueAsset)),
    make_shared<MagicVariableDeclaration>("destroyasset", make_shared<FunctionType>(strings{"uint256","uint256"}, strings{"uint256"}, FunctionType::Kind::DestroyAsset)),
    make_shared<MagicVariableDeclaration>("getaccountid", make_shared<FunctionType>(strings{"string memory"}, strings{"uint256"}, FunctionType::Kind::GetAccountID)),
	make_shared<MagicVariableDeclaration>("getassetid", make_shared<FunctionType>(strings{"string memory"}, strings{"int64"}, FunctionType::Kind::GetAssetID)),
    make_shared<MagicVariableDeclaration>("assetinfo", make_shared<FunctionType>(strings{"uint256","uint256","bytes memory"}, strings{"uint256"}, FunctionType::Kind::AssetInfo)),
    make_shared<MagicVariableDeclaration>("snapshottime", make_shared<FunctionType>(strings{"uint256","uint256"}, strings{"uint256"}, FunctionType::Kind::SnapshotTime)),
    make_shared<MagicVariableDeclaration>("getaccounttime", make_shared<FunctionType>(strings{"uint256"}, strings{"uint256"}, FunctionType::Kind::GetAccountTime)),
    make_shared<MagicVariableDeclaration>("cryptocalc", make_shared<FunctionType>(strings{"bytes memory", "bytes memory","bytes memory","uint256"}, strings{"uint256"}, FunctionType::Kind::CryptoCalc)),
    make_shared<MagicVariableDeclaration>("deductgas", make_shared<FunctionType>(strings{"uint256"}, strings{"uint256"}, FunctionType::Kind::DeductGas)),
	make_shared<MagicVariableDeclaration>("withdrawfee", make_shared<FunctionType>(strings{"uint256","uint256"}, strings{"uint256"}, FunctionType::Kind::WithdrawFee)),
    make_shared<MagicVariableDeclaration>("getepoch", make_shared<FunctionType>(strings{"uint256","uint256"}, strings{"uint256","uint256"}, FunctionType::Kind::GetEpoch)),
    make_shared<MagicVariableDeclaration>("getcandidatenum", make_shared<FunctionType>(strings{"uint256"}, strings{"uint256"}, FunctionType::Kind::GetCandidateNum)),
    make_shared<MagicVariableDeclaration>("getcandidate", make_shared<FunctionType>(strings{"uint256","uint256"}, strings{"uint256","uint256","uint256","uint256","uint256","uint256","uint256"}, FunctionType::Kind::GetCandidate)),
    make_shared<MagicVariableDeclaration>("getvoterstake", make_shared<FunctionType>(strings{"uint256","uint256", "uint256"}, strings{"uint256"}, FunctionType::Kind::GetVoterStake)),
    //
