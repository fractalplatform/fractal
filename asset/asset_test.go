...
func TestAsset_GetAssetObjectByName(t *testing.T) {
	...
	ao, _ := NewAssetObject("ft", "zz", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	ao.SetAssetId(1)
	ast.addNewAssetObject(ao)
	ao1, _ := NewAssetObject("ft2", "zz2", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	ao1.SetAssetId(2)
...
func TestAsset_addNewAssetObject(t *testing.T) {
	...
	ao3, _ := NewAssetObject("ft3", "zz3", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	//ao1.SetAssetId(3)
...
func TestAsset_getAssetCount(t *testing.T) {
	...
	ao, _ := NewAssetObject("ft2", "zz2", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	//ao.SetAssetId(1)
	ast.IssueAssetObject(ao)
...
func TestAsset_SetAssetObject(t *testing.T) {
	...
	ao4, _ := NewAssetObject("ft4", "zz4", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	ao4.SetAssetId(0)
	ao5, _ := NewAssetObject("ft5", "zz5", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	ao5.SetAssetId(55)
	tests := []struct {
		name    string
		fields  fields
...
func TestAsset_IssueAssetObject(t *testing.T) {
	...
	ao6, _ := NewAssetObject("ft6", "zz6", big.NewInt(1000), 10, common.Name("a123456789aeee"))
	ao6.SetAssetId(11)
	tests := []struct {
		name    string
		fields  fields
...
func TestAsset_IssueAsset(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if err := a.IssueAsset(tt.args.assetName, tt.args.symbol, tt.args.amount, tt.args.dec, tt.args.owner); (err != nil) != tt.wantErr {
